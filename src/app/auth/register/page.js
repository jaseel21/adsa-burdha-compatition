...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (membersCount < 1 || membersCount > 20) {
      setError('Members count must be between 1 and 20');
      return;
    }
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-amber-900/50 via-transparent to-red-900/50"></div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-8">
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-sm">
              Create your team account and join the competition
            </p>
          </div>
          ...
          <div className="backdrop-blur-lg bg-white/10 p-8 rounded-2xl shadow-2xl border border-white/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:border-transparent transition-all duration-200"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-white/60 text-xs mt-1">Enter a number between 1 and 20</p>
              </div>
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-green-500/10 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute top-1/2 right-10 w-16 h-16 bg-emerald-500/10 rounded-full blur-lg animate-pulse delay-1000"></div>
      </div>
    </div>
  );
}